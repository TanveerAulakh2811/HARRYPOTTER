...
function openNextPages() {
    ...
    switch (currentPage) {
        case 1:
            ...
            document.getElementById('page2').innerHTML = "<img src='letter.jpg' alt='Picture 2'>";
            break;
        case 2:
            ...
            document.getElementById('page2').innerHTML = "<img src='quote1.jpg' alt='Picture 3'>";
            break;
        case 3:
            ...
            document.getElementById('page2').innerHTML = "<img src='platform.jpg' alt='Picture 4'>";
            break;
        case 4:
            // Replace content for pages 5 and 6
            ...
            document.getElementById('page2').innerHTML = "<img src='hedwig.jpg' alt='Picture 5'>";
            break;
        case 5:
            // Replace content for pages 5 and 6
            ...
            document.getElementById('page2').innerHTML = "<img src='Hermoine.jpg' alt='Picture 6'>";
            break;
        case 6:
            // Show cover again
